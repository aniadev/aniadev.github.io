...
Trên mô hình eUTXO, một trạng thái dùng chung là một UTXO - và mỗi UTXO chỉ cho phép *một* giao dịch tiêu tại một thời điểm. Đặt cả một bảng xếp hạng lên một UTXO nghĩa là mọi lượt cập nhật đều tranh chấp cùng một đầu ra: thông lượng giảm còn một giao dịch mỗi block.
