...
Với tiền mã hoá, mối đe doạ lượng tử không nhắm vào thuật toán đào (hàm băm), mà nhắm vào *chữ ký số bảo vệ ví*. Đó là hai lớp phòng thủ khác nhau, và chúng chịu tổn thương rất khác nhau.
::
...
**Cardano: thiết kế để tiến hoá.** Cardano dựng theo lớp và mô-đun, với chủ đích cho phép hoán đổi từng phần. Nếu lớp mật mã bảo vệ ví cần nâng cấp, nó có thể thay mà không làm sập hệ thống. Nền tảng phương pháp hình thức (formal methods) và quy trình peer-review không đảm bảo "không thể bị tấn công", nhưng làm cho việc thay lõi trở thành một thao tác có kế hoạch chứ không phải một cuộc phẫu thuật tim hở.

::callout{type="insight" title="Khác biệt cốt lõi"}
Bitcoin đặt cược vào *tính bất biến*; Cardano đặt cược vào *khả năng thay đổi có kiểm soát*. Trước một mối đe doạ mật mã đã biết trước hàng năm, khả năng nâng cấp không phá vỡ mới là tài sản quyết định.
::
...
- **Midnight và "Nightstream".** Sidechain bảo mật của Cardano, thiết kế kháng lượng tử từ đầu, dùng mật mã lattice và có thể tăng tốc bằng GPU thay vì phần cứng chuyên dụng đắt đỏ - điều làm việc triển khai thực tế hơn nhiều.
...
Mối đe doạ lượng tử là có thật, và mốc thời gian đã được đặt lên bàn. Bitcoin, với triết lý cứng và sự phụ thuộc vào ECDSA, sẽ đối mặt một cuộc nâng cấp cực khó nếu ngày đó tới. Cardano đứng ở vị thế khác - không phải vì nó "miễn nhiễm", mà vì kiến trúc của nó coi việc thay lõi mật mã là một tình huống đã lường trước.

Khác biệt cuối cùng không nằm ở việc chain nào có thuật toán hậu lượng tử tốt hơn. Nó nằm ở chỗ: khi bài toán khó ập đến, chain nào *thay được lõi mà không phải phá đi xây lại*. Đó là thứ khó thấy trong lúc bình yên, và là thứ duy nhất đáng giá khi bão tới.
